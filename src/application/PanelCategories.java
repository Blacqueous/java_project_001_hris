...
public class PanelCategories extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        panel_breadcrumb_title.setMinimumSize(new java.awt.Dimension(126, 35));
        panel_breadcrumb_title.setOpaque(false);
        panel_breadcrumb_title.setPreferredSize(new java.awt.Dimension(126, 35));
        ...
        label_breadcrumb_title.setText("CATEGORIES");
        panel_breadcrumb_title.add(label_breadcrumb_title, java.awt.BorderLayout.CENTER);

        label_breadcrumb_logo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/merged/white/icon_25_category.png"))); // NOI18N
