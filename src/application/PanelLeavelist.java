 ...
 * @author egrubellano
 */
public class PanelLeavelist extends javax.swing.JPanel {

    /**
     * Creates new form PanelDashboard
     */
    public PanelLeavelist() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        panel_breadcrumb_title.setMinimumSize(new java.awt.Dimension(118, 35));
        panel_breadcrumb_title.setOpaque(false);
        panel_breadcrumb_title.setPreferredSize(new java.awt.Dimension(118, 35));
        ...
        label_breadcrumb_title.setText("LEAVE LIST");
        panel_breadcrumb_title.add(label_breadcrumb_title, java.awt.BorderLayout.CENTER);

        label_breadcrumb_logo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/merged/white/icon_25_leave_left.png"))); // NOI18N
        label_breadcrumb_logo.setBorder(javax.swing.BorderFactory.createEmptyBorder(2, 0, 0, 0));
