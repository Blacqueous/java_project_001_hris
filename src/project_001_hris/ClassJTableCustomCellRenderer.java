...
public class ClassJTableCustomCellRenderer {
    ...
    public TableCellRenderer StringCellRenderer() {
        ...
        return new TableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
                ...
                if(row%2 == 0) {
                    DEFAULT_COMPONENT.setBackground(new Color(245, 245, 245));
                } else {
                    DEFAULT_COMPONENT.setBackground(new Color(250, 250, 250));
                }
                
                if(isSelected) {
                    DEFAULT_COMPONENT.setBackground(table.getSelectionBackground().brighter());
                }
