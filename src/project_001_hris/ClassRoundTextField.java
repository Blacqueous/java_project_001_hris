 ...
 * @author egrubellano
 */
public class ClassRoundTextField extends JTextField {
...
//        setImage();
    ...
    @Override 
     protected void paintComponent(Graphics g) { 
        ...
        //if(getImage()!=null){ 
            g2.drawImage(new ImageIcon(getClass().getResource("./a.jpg")).getImage(), 5, 2, getHeight()-3, getHeight()-3, null); 
