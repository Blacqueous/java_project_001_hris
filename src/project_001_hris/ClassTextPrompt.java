...
/**
 * The ClassTextPrompt class will display a prompt over top of a text component
 ...
 * class construction.
 */
public class ClassTextPrompt extends JLabel
    ...
    public ClassTextPrompt(String text, JTextComponent component) {
        this(text, component, Show.ALWAYS);
    }

    public ClassTextPrompt(String text, JTextComponent component, Show show) {
