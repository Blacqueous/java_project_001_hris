 ...
 * @author Web Dev
 */
public final class DialogCreateDep extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public DialogCreateDep(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setIconImage(new javax.swing.ImageIcon(getClass().getResource("/img_src/icon_16_user_silhouette_question.png")).getImage());
...
//            }
    ...
    public void setPlaceHolder() {
        ...
        ClassTextPrompt tpTxtfldName = new ClassTextPrompt("Enter a Name", txtfldName);
        JTextFieldDateEditor dateTextEditor = (JTextFieldDateEditor) dateSelected.getDateEditor();
    ...
    private DialogCreateDep getThisDialog() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogCreateDep.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                DialogCreateDep dialog = new DialogCreateDep(new javax.swing.JFrame(), true);
