 ...
 * @author Web Dev
 */
public final class DialogCreateTrn extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public DialogCreateTrn(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setIconImage(new javax.swing.ImageIcon(getClass().getResource("/img_src/icon_16_star.png")).getImage());
...
//            }
    ...
    private DialogCreateTrn getThisDialog() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogCreateTrn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                DialogCreateTrn dialog = new DialogCreateTrn(new javax.swing.JFrame(), true);
